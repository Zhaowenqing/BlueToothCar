...
set_property -dict { PACKAGE_PIN H4    IOSTANDARD LVCMOS33 } [get_ports { SPD_out[1] }]; #IO_L21N_T3_DQS_35 Sch=jd[1]
set_property -dict { PACKAGE_PIN H1    IOSTANDARD LVCMOS33 } [get_ports { clk1K }]; #IO_L17P_T2_35 Sch=jd[2]
set_property -dict { PACKAGE_PIN G1    IOSTANDARD LVCMOS33 } [get_ports { SPD_out[2] }]; #IO_L17N_T2_35 Sch=jd[3]
set_property -dict { PACKAGE_PIN G3    IOSTANDARD LVCMOS33 } [get_ports { SPD_out[3] }]; #IO_L20N_T3_35 Sch=jd[4]
...
set_property -dict { PACKAGE_PIN G2    IOSTANDARD LVCMOS33 } [get_ports { SPD_out[0] }]; #IO_L15N_T2_DQS_35 Sch=jd[9]
