...
proc create_root_design { parentCell } {
  ...
  set SPD_out [ create_bd_port -dir O -from 3 -to 0 SPD_out ]
  ...
  set_property -dict [ list CONFIG.C_ALL_OUTPUTS {1} CONFIG.C_GPIO_WIDTH {16}  ] $axi_gpio_1

  # Create instance: axi_gpio_2, and set properties
  set axi_gpio_2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 axi_gpio_2 ]
  set_property -dict [ list CONFIG.C_ALL_OUTPUTS {1} CONFIG.C_GPIO_WIDTH {8}  ] $axi_gpio_2
...
CONFIG.USE_LOCKED {false} CONFIG.USE_RESET {false} \
  ...
  # Create instance: mainController_0, and set properties
  set mainController_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:mainController:1.0 mainController_0 ]
  ...
  connect_bd_net -net MIPS_MicroAptiv_UP_0_HCLK [get_bd_pins MIPS_MicroAptiv_UP_0/HCLK] [get_bd_pins PWM_w_Int_0/s00_axi_aclk] [get_bd_pins ahblite_axi_bridge_0/s_ahb_hclk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_gpio_2/s_axi_aclk] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M04_ACLK] [get_bd_pins axi_interconnect_0/M05_ACLK] [get_bd_pins axi_interconnect_0/M06_ACLK] [get_bd_pins axi_interconnect_0/M07_ACLK] [get_bd_pins axi_interconnect_0/M08_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_uart16550_0/s_axi_aclk] [get_bd_pins axi_uart16550_1/s_axi_aclk] [get_bd_pins mainController_0/clk50M]
  ...
  connect_bd_net -net UART_TXD_IN_1 [get_bd_ports UART_TXD_IN] [get_bd_pins axi_uart16550_1/sin]
  ...
  connect_bd_net -net axi_gpio_1_gpio_io_o [get_bd_pins axi_gpio_1/gpio_io_o] [get_bd_pins mainController_0/SPD]
  connect_bd_net -net axi_gpio_2_gpio_io_o [get_bd_pins axi_gpio_2/gpio_io_o] [get_bd_pins mainController_0/DRT]
  connect_bd_net -net axi_intc_0_irq [get_bd_pins axi_intc_0/irq] [get_bd_pins xlconcat_0/In4]
  connect_bd_net -net axi_uart16550_0_sout [get_bd_ports RX] [get_bd_pins axi_uart16550_0/sout]
  connect_bd_net -net axi_uart16550_1_sout [get_bd_ports UART_RXD_OUT] [get_bd_pins axi_uart16550_1/sout]
  ...
  connect_bd_net -net mainController_0_DIR_enable [get_bd_ports DIR_enable] [get_bd_pins mainController_0/DIR_enable]
  connect_bd_net -net mainController_0_DIR_latch [get_bd_ports DIR_latch] [get_bd_pins mainController_0/DIR_latch]
  connect_bd_net -net mainController_0_DIR_serial [get_bd_ports DIR_serial] [get_bd_pins mainController_0/DIR_serial]
  connect_bd_net -net mainController_0_SPD_out [get_bd_ports SPD_out] [get_bd_pins mainController_0/SPD_out]
  connect_bd_net -net mainController_0_clk1K [get_bd_ports clk1K] [get_bd_pins mainController_0/clk1K]
  ...
  connect_bd_net -net sin_1 [get_bd_ports TX] [get_bd_pins axi_uart16550_0/sin]
  ...
  connect_bd_net -net xlconstant_4_dout [get_bd_pins xlconcat_1/In0] [get_bd_pins xlconcat_1/In1] [get_bd_pins xlconcat_1/In2] [get_bd_pins xlconcat_1/In3] [get_bd_pins xlconcat_1/In5] [get_bd_pins xlconcat_1/In6] [get_bd_pins xlconcat_1/In7] [get_bd_pins xlconstant_4/dout]
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x10800000 [get_bd_addr_spaces MIPS_MicroAptiv_UP_0/ahblite] [get_bd_addr_segs axi_gpio_2/S_AXI/Reg] SEG_axi_gpio_2_Reg
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x10500000 [get_bd_addr_spaces MIPS_MicroAptiv_UP_0/ahblite] [get_bd_addr_segs axi_uart16550_1/S_AXI/Reg] SEG_axi_uart16550_1_Reg
